...
module.exports = {
  ...
  networks: {
    ...
    // }
    elatest: {
      provider: () => new HDWalletProvider({mnemonic: mnemonicStr, providerOrUrl:`https://api-testnet.elastos.io/eth`}),
    ...
    heco: {
      ...
      //provider: () => new HDWalletProvider({mnemonic: mnemonicStr, providerOrUrl:`https://http-mainnet.hecochain.com`}),
